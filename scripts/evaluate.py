...
def main() -> None:
    ...
    parser.add_argument("dataset", type=str, help="Path to JSONL with fields: question, contexts, answer, ground_truths")
    parser.add_argument("--out", type=str, default=None, help="(Deprecated) Path to write JSON report")
    parser.add_argument("--out-json", type=str, default="reports/ragas_report.json", help="Path to write JSON report")
    parser.add_argument("--out-md", type=str, default="reports/ragas_report.md", help="Path to write Markdown summary")
    parser.add_argument("--limit", type=int, default=0, help="Limit number of samples (0 = all)")
    parser.add_argument("--metrics", type=str, nargs="*", default=None, help="Metrics to compute (e.g., faithfulness answer_relevancy)")
